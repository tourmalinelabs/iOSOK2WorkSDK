Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/tourmalinelabs/iOSOK2WorkSDK/raw/master/OK2Work/1.0.4/OK2Work.zip' }
  ...
  s.script_phase = [{
      :name => 'Patch SQLite.swift',
      :script => 'sed -i \'\' -e \'s/@import SQLite3;/@import SQLCipher.sqlite3;/g\' ${PODS_ROOT}/SQLite.swift/Sources/SQLiteObjc/include/SQLiteObjc.h',
